    ...
    , ui(new Ui::MainWindow)
{
    ...
    player_red_resources[Terrain_type::ore] = 20;
    player_red_resources[Terrain_type::brick] = 20;
    player_red_resources[Terrain_type::grain] = 20;
    player_red_resources[Terrain_type::lumber] = 20;
    player_red_resources[Terrain_type::wool] = 20;
