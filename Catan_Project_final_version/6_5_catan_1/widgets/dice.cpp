...
Dice::Dice(QWidget *parent): QPushButton(parent)
{
    ...
    diceLabel1->setPixmap(QPixmap(":/dice/assets/dice/dice_6.png").scaled(75,75));
    diceLabel2->setPixmap(QPixmap(":/dice/assets/dice/dice_6.png").scaled(75,75));
...
void Dice::roll()
{
    ...
    QString pathStr1 = ":/dice/assets/dice/dice_"+ QString::number(diceNumber1) +".png";
    QString pathStr2 = ":/dice/assets/dice/dice_"+ QString::number(diceNumber2) +".png";
    diceLabel1->setPixmap(QPixmap(pathStr1).scaled(75,75));
    diceLabel2->setPixmap(QPixmap(pathStr2).scaled(75,75));
    show();
}

int Dice::get_dice_number()
{
