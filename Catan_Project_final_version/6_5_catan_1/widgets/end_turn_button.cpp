...
End_turn_button::End_turn_button(QWidget *parent) : QPushButton(parent)
{
    ...
    resize(84,84);
    move(pos_x,pos_y);
    wait_pic=QPixmap(":/player_related/assets/player_related/icon_hourglass.png");
    wait_pic=wait_pic.scaled(54,54);
    ok_to_end_turn=QPixmap(":/player_related/assets/player_related/icon_pass_turn.png");
