    ...
    , ui(new Ui::MainWindow)
{
    ...
    QPixmap sea_shore_pic(":/background/picture_sources/background/sea_shore.png");
    ...
    qDebug() << source_card_number.size();
    ...
    actionReboot->resize(100,100);
    actionReboot->setIconSize(QSize(100,100));

    actionReboot->setIcon(QIcon(QPixmap(":/player_related/picture_sources/player_related/main_menu.jpg")));
    ...
    bk_labels[1]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_player_inactive1.png"));
    bk_labels[2]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_player_inactive1.png"));
    source_card_number[0]->setText(QString::number(players[0].get_owned_sources()[Terrain_type::lumber]));
    source_card_number[1]->setText(QString::number(players[0].get_owned_sources()[Terrain_type::grain]));
    source_card_number[2]->setText(QString::number(players[0].get_owned_sources()[Terrain_type::brick]));
    source_card_number[3]->setText(QString::number(players[0].get_owned_sources()[Terrain_type::wool]));
    ...
    for(int temp=0;temp<72;temp++)
    {
        ...
        connect(temp_disp,&Road_disp::game_status_updated,this,[diceButton](){
            ...
            case 2:
            {
                bk_labels[1]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_section1.png"));
                bk_labels[0]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_player_inactive1.png"));
                current_player=player_type::green_player;
                current_player_index=1;
                current_player_state=player_state::is_building_small_house;
                for(int temp=0;temp<54;temp++)
            ...
            case 4:
            {
                bk_labels[2]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_section1.png"));
                bk_labels[1]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_player_inactive1.png"));
                current_player=player_type::blue_player;
                current_player_index=2;
                current_player_state=player_state::is_building_small_house;
            ...
            case 10:
            {
                bk_labels[0]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_section1.png"));
                bk_labels[1]->setPixmap(QPixmap(":/player_related/picture_sources/player_related/bg_player_inactive1.png"));
                current_player=player_type::red_player;
                current_player_index=0;
                current_player_state=player_state::is_building_small_house;
    ...
    QPixmap opening_pic(":/background/picture_sources/background/background.png");
    ...
    QPixmap opening_logo_pic(":/background/picture_sources/background/logo.png");
    ...
    QPixmap printing_pic(":/background/picture_sources/background/page_bg.png");
    ...
    normal_game_button->setIcon(QIcon(QPixmap(":/background/picture_sources/background/classic_mode_button.png")));
    ...
    connect(normal_game_button,&QPushButton::clicked,[opening_bg,opening_logo,printing_bg,normal_game_button,quit_game_button,advanced_game_button](){
        opening_bg->hide();
        opening_logo->hide();
        printing_bg->hide();
    ...
    advanced_game_button->setIcon(QIcon(QPixmap(":/background/picture_sources/background/advanced_mode.png")));
    ...
    connect(advanced_game_button,&QPushButton::clicked,[opening_bg,opening_logo,printing_bg,normal_game_button,quit_game_button,advanced_game_button,sea_shore_label](){
        opening_bg->hide();
        opening_logo->hide();
        printing_bg->hide();
        normal_game_button->setDisabled(true);
    ...
    quit_game_button->setIcon(QIcon(QPixmap(":/background/picture_sources/background/quit_bg.png")));
