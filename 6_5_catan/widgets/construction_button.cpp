...
Construction_button::Construction_button(enum constructon facility,QWidget *parent) : QPushButton(parent)
{
    ...
    red_corner=QPixmap(":/player_related/picture_sources/player_related/button_badge_background_red.png");
    red_corner=red_corner.scaled(28,28);

    green_corner=QPixmap(":/player_related/picture_sources/player_related/button_badge_background_green.png");
    green_corner=green_corner.scaled(28,28);

    blue_corner=QPixmap(":/player_related/picture_sources/player_related/button_badge_background_blue.png");
    ...
    red_road=QPixmap(":/road/picture_sources/road/road_red.png");
    red_road=red_road.scaled(50,50);
    red_small_house=QPixmap(":/settlements/picture_sources/settlements/settlement_red.png");
    red_small_house=red_small_house.scaled(50,50);
    red_big_house=QPixmap(":/city/picture_sources/city/city_red.png");
    red_big_house=red_big_house.scaled(50,50);

    green_road=QPixmap(":/road/picture_sources/road/road_green.png");
    green_road=green_road.scaled(50,50);
    green_small_house=QPixmap(":/settlements/picture_sources/settlements/settlement_green.png");
    green_small_house=green_small_house.scaled(50,50);
    green_big_house=QPixmap(":/city/picture_sources/city/city_green.png");
    green_big_house=green_big_house.scaled(50,50);

    blue_road=QPixmap(":/road/picture_sources/road/road_blue.png");
    blue_road=blue_road.scaled(50,50);
    blue_small_house=QPixmap(":/settlements/picture_sources/settlements/settlement_blue.png");
    blue_small_house=blue_small_house.scaled(50,50);
    blue_big_house=QPixmap(":/city/picture_sources/city/city_blue.png");
