    ...
    : x{xs[i]}, y{ys[i]}
{
    ...
    case Terrain_type::brick:
        tile_pic = QPixmap(QString(":/tile/assets/tile/tile_brick.png"));
        break;
    case Terrain_type::ore:
        tile_pic = QPixmap(QString(":/tile/assets/tile/tile_ore.png"));
        break;
    case Terrain_type::desert:
        tile_pic = QPixmap(QString(":/tile/assets/tile/tile_desert.png"));
        break;
    case Terrain_type::lumber:
        tile_pic = QPixmap(QString(":/tile/assets/tile/tile_lumber.png"));
        break;
    case Terrain_type::wool:
        tile_pic = QPixmap(QString(":/tile/assets/tile/tile_wool.png"));
        break;
    case Terrain_type::grain:
        tile_pic = QPixmap(QString(":/tile/assets/tile/tile_grain.png"));
        break;
    }
    switch(numbers[i]){
    case 2:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_2.png"));
        break;
    case 3:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_3.png"));
        break;
    case 4:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_4.png"));
        break;
    case 5:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_5.png"));
        break;
    case 6:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_6.png"));
        break;
    case 8:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_8.png"));
        break;
    case 9:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_9.png"));
        break;
    case 10:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_10.png"));
        break;
    case 11:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_11.png"));
        break;
    case 12:
        num_pic = QPixmap(QString(":/prob/assets/prob/prob_12.png"));
        break;
    }
}
